...
namespace RSADone
{
    class RSAImplementation
    {
        ...
        {
            Console.WriteLine("Welcome to the RSA encryption algorithm!!");
            Console.WriteLine("\n");
            Console.WriteLine("The five steps to key generation: \n");
            Console.WriteLine("\n");
            RSAImplementation rsa = new RSAImplementation();
            rsa.generateKeys();
            Console.WriteLine("\nKey size: " + rsa.getKeyLength());
            Console.WriteLine("\nPrivate key value: " + rsa.getPrivKey() + "\nPublic key value: \n" + rsa.getPubKey());
            Console.WriteLine("\n");
